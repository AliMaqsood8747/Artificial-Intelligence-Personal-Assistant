...
def wishme():
    welcome_message = f"Welcome Back Ali"
    ...
    def clicked(self):
        ...
        if 'time' in query:
           show_time()
            ...
            url = 'Generate url for your city: from https://api.openweathermap.org'
